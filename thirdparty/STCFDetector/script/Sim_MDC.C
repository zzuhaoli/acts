...
int setupG4_CINT(bool interactive)  {
  ...
  kernel.loadGeometry(("file:"+install_dir+"/examples/ClientTests/compact/detectorMDC.xml").c_str());
  ...
  setupDetector(kernel,"MultiLayerDriftChamber");
