...
void ReadRootFile()
{
  ...
  //TFile *file = new TFile("MySD_2018-12-21_17-55.root");
  //TFile *file = new TFile("MySD_2018-12-21_23-45.root");
  TFile *file = new TFile("MySD_2018-12-25_23-05.root");
  //TFile *file = new TFile("MDC_2018-12-26_10-47.root");
  if (file==0) return;
  ...
  vector<Hit*> *hit_v = new vector<Hit*>;
  tree->SetBranchAddress("ECALPMTBARREL", &hit_v);
