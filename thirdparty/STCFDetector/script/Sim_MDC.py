...
def run():
  ...
  kernel.loadGeometry("file:../compact/detectorMDC.xml")
  ...
  prt.OutputLevel = Output.ERROR
  prt.OutputType  = 3 # Print both: table and tree
  kernel.eventAction().adopt(prt)

  # Configure I/O
  evt_root = geant4.setupROOTOutput('RootOutput','MDC_'+time.strftime('%Y-%m-%d_%H-%M'),mc_truth=False)
  # Setup particle gun
  ...
  geant4.setupTracker('MultiLayerDriftChamber')
