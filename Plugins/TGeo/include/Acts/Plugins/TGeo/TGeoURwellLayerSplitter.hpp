...
/// @brief TGeoURwellLayerSplitter
///
/// Split Cylinder and disks into submodules
class TGeoURwellLayerSplitter : public ITGeoDetectorElementSplitter {
 public:
  ...
  TGeoURwellLayerSplitter(const Config& cfg,
                          std::unique_ptr<const Acts::Logger> logger =
                              Acts::getDefaultLogger("TGeoURwellLayerSplitter",
                                                     Acts::Logging::INFO));

  virtual ~TGeoURwellLayerSplitter() = default;
