...
void myText(Double_t x,Double_t y,Color_t color, float font, const char *text) {
...
void ATLASLabel(Double_t x,Double_t y, Color_t color, Double_t tsize=0.05, std::string text = "Internal", double delx = 0)
{
  TLatex l; 
  //l.SetTextAlign(12); 
  l.SetTextSize(tsize); 
